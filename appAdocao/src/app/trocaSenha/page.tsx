...
export default function TrocaSenha() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-200  dark:bg-customBg">
      ...
      <div className="bg-white p-8 rounded shadow-md w-full max-w-md  dark:bg-white
 dark:border-gray-700">
        <h2 className="text-2xl font-bold mb-6 text-center  text-gray-900 md:text-2xl dark:text-customGray">Esqueceu sua senha?</h2>
        {!codigoEnviado ? (
          <>
            <input
              type="email"
