...
export function InputPesquisa({setAnimais}: InputPesquisaProps){
        ...
        <section className="flex max-w-5xl mx-auto mt-3">
            ...
            <form className="flex-1"
                ...
                <div className="relative">
                    ...
                    <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-customGrayBar focus:ring-blue-500 focus:border-blue-500 dark:bg-customGrayBar dark:border-gray-600 dark:placeholder-gray-700 dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                    placeholder="Encontre o seu novo amigo... (Idade, espécie ou nome)" 
                    required
                    {...register("termo")} />
